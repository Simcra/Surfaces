...
underground_entrance.icon = "__Surfaces__/graphics/icons/access-shaft/underground-access-shaft-lower.png"
...
underground_exit.icon = "__Surfaces__/graphics/icons/access-shaft/underground-access-shaft-upper.png"
